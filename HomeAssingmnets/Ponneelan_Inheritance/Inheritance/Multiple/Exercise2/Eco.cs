...
namespace Exercise2
{
    public class Eco : Car,IBrand
    {
        ...
        public Eco(string fuelType,int seatsCount,string color,int tankCapacity,int kmDriven,string chaseNumber, string engineNumber,string modelName) : base(fuelType,seatsCount,color,tankCapacity,kmDriven)
        {
            s_makingNumber++;
